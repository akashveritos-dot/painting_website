...
CREATE TABLE IF NOT EXISTS users
    (
        ...
        UPDATE
            CURRENT_TIMESTAMP,
            INDEX idx_user_email (email) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
-- 2. Sessions Table
...
CREATE TABLE IF NOT EXISTS categories
    (
        ...
        UPDATE
            CURRENT_TIMESTAMP,
            INDEX idx_category_slug (slug) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
-- 4. Products Table
...
CREATE TABLE IF NOT EXISTS orders
    (
        ...
        DELETE
            RESTRICT,
            INDEX idx_order_user (user_id) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
-- 8. Order Items Table
CREATE TABLE IF NOT EXISTS order_items
    (
        ...
        DELETE
            ...
            INDEX idx_item_product (product_id) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
-- 9. Cart Items Table
CREATE TABLE IF NOT EXISTS cart_items
    (
        ...
        DELETE
            ...
            INDEX idx_cart_user (user_id) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS wishlist_items
    (
        ...
        DELETE
            ...
            INDEX idx_wishlist_user (user_id) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
-- 11. Payments Table
...
CREATE TABLE IF NOT EXISTS reviews
    (
        ...
        DELETE
            ...
            INDEX idx_review_product (product_id) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS blogs
    (
        ...
        UPDATE
            CURRENT_TIMESTAMP,
            INDEX idx_blog_slug (slug) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS artists
    (
        ...
        UPDATE
            CURRENT_TIMESTAMP,
            INDEX idx_artist_slug (slug) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS collections
    (
        ...
        UPDATE
            CURRENT_TIMESTAMP,
            INDEX idx_collection_slug (slug) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
-- 20. Banners Table
